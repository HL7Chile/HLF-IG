...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'motivo']) &gt;= 1">extension with URL = 'motivo': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'motivo']) &lt;= 1">extension with URL = 'motivo': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'motivoDet']) &lt;= 1">extension with URL = 'motivoDet': maximum cardinality of 'extension' is 1</sch:assert>
