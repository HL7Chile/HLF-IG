...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://hospitallaflorida.cl/fhir/hlfhosp/StructureDefinition/CodigoPais']) &lt;= 1">extension with URL = 'https://hospitallaflorida.cl/fhir/hlfhosp/StructureDefinition/CodigoPais': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hospitallaflorida.cl/fhir/hlfhosp/StructureDefinition/NivelInstruccion']) &lt;= 1">extension with URL = 'https://hospitallaflorida.cl/fhir/hlfhosp/StructureDefinition/NivelInstruccion': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hospitallaflorida.cl/fhir/hlfhosp/StructureDefinition/Discapacidad']) &lt;= 1">extension with URL = 'https://hospitallaflorida.cl/fhir/hlfhosp/StructureDefinition/Discapacidad': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hospitallaflorida.cl/fhir/hlfhosp/StructureDefinition/TipoViaDireccion']) &lt;= 1">extension with URL = 'https://hospitallaflorida.cl/fhir/hlfhosp/StructureDefinition/TipoViaDireccion': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:use) &gt;= 1">use: minimum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
